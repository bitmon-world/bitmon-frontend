    ...
    <div className="relative z-10 mx-4 h-full pb-10">
      ...
      <div className="mt-6">
        ...
        <div className="flexArea">
          ...
          <div className=" mx-auto py-5 flex-item">
            <div className="my-4">
              <a href="https://github.com/vibingstudio/vibing-launcher/releases/download/v0.1.1/Vibing.Launcher.Setup.0.1.2.exe" target="_blank" data-inline="true">
                <div
                  className={
          ...
          <div className="  mx-auto py-5 flex-row">
            <div className="my-4">
              <a href="https://github.com/vibingstudio/vibing-launcher/releases/download/v0.1.1/Vibing.Launcher-0.1.2.dmg" target="_blank" data-inline="true">
                <div
                  className={
